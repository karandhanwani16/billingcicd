...
let creditnotetable = new CreditNoteTable();
let addRow = document.querySelector(".add-row");
let bankTableBody = document.querySelector("#creditnoteTable");
...
function refreshView() {
    bankTableBody.innerHTML = creditnotetable.displayRows();
    creditnotetable.calculateAllMetrics();
    creditnoteObject.total = creditnotetable.total;
...
function enterMetricsIntoHtml() {
    document.getElementById("lblcgst").innerHTML = creditnotetable.cGst;
    document.getElementById("lblsgst").innerHTML = creditnotetable.sGst;
    document.getElementById("lbligst").innerHTML = creditnotetable.iGst;
    document.getElementById("lblroundoff").innerHTML = creditnotetable.roundOff;
    document.getElementById("lbltotal").innerHTML = creditnotetable.total;
}

// edit functionality support functions

function addEditInputs(id) {
    let InvoiceTableCont = document.querySelector("#creditnoteTable");
...
function addSaveFunctionality(id) {
    ...
    saveButtons.forEach(saveButton => {
        saveButton.addEventListener("click", e => {
            ...
            creditnotetable.updateRow(id, rowPayload);
            refreshView();
        });
    });
...
addRow.addEventListener("click", e => {
    if (mainCharges.value == "" || amount.value == "") {
        ...
        creditnotetable.insertRow(mainCharges.value, amount.value, hsn.value);
        refreshView();
        // clear inputs
        clearInputs();
    }
