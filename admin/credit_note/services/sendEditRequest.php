...
try {
    $maxRequestId = getCurrentId("credit_note_edit_request_id", "credit_note_edit_request", $con);

    $sql = "insert into credit_note_edit_request values(" . $maxRequestId . "," . $id . "," . $user_id . ",'" . getCurrentTimestamp() . "','false','false','" . $message . "')";
