...
<body>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">Credit Note</div>
    ...
    <div class="hidden popup">
        ...
        <div class="credit_note-details">
            <div class="roww">
                <div class="data-label">Credit Note ID</div>
                <div class="data-value" id="lblcredit_noteid">1</div>
            </div>
            <div class="roww">
            ...
            <div class="roww">
                <div class="data-label">Credit Note No.</div>
                <div class="data-value" id="lblcredit_noteno">1250</div>
            </div>
            <div class="roww">
                <div class="data-label">Credit Note Date.</div>
                <div class="data-value" id="lblcredit_notedate">2022-10-20</div>
            </div>
        </div>
    ...
    <script>
        ...
        let creditNoteIdLabel = document.querySelector("#lblcredit_noteid");
        let firmLabel = document.querySelector("#lblfirm");
        let supplierLabel = document.querySelector("#lblsupplier");
        let creditNoteNoLabel = document.querySelector("#lblcredit_noteno");
        let creditNoteDateLabel = document.querySelector("#lblcredit_notedate");
        ...
        function addPopupListener() {
            ...
            editReuestButtons.forEach(editReuestButton => {
                editReuestButton.addEventListener("click", e => {
                    let currentCreditNoteId = editReuestButton.attributes["data-id"].value;
                    openPopup();
        ...
        // main functions
        // load data function
        function getInvoiceData(credit_note_id) {
            var xmlhttp = new XMLHttpRequest();
            xmlhttp.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    var result = JSON.parse(this.responseText);
                    if (!(Object.keys(result).length === 0)) {
                        loadDataIntoPopUpLabels(result.credit_note_id, result.firm_name, result.supplier_name, result.credit_note_no, result.credit_note_date);
                        submitButton.classList.remove("disabled");
                        submitButton.attributes["data-id"].value = credit_note_id;
                    } else {
            ...
            xmlhttp.open("POST", `services/getCreditNoteLabelData.php`, true);
            xmlhttp.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
            xmlhttp.send(`id=${credit_note_id}`);
        }
        // load labels
        function loadDataIntoPopUpLabels(credit_note_id, firm_name, supplier_name, credit_note_no, credit_note_date) {
            creditNoteIdLabel.innerHTML = credit_note_id;
            firmLabel.innerHTML = firm_name;
            supplierLabel.innerHTML = supplier_name;
            creditNoteNoLabel.innerHTML = credit_note_no;
            creditNoteDateLabel.innerHTML = credit_note_date;
        }
    </script>
    <!-- pop up end -->
    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function() {
            ...
            var dataTable = $('#sample_data').DataTable({
                ...
                "order": [],
                "ajax": {
                    url: "services/getCreditNoteData.php",
                    type: "POST"
                },
            ...
            function downloadPdf(btn, id) {
                ...
                xmlhttp.open("POST", `services/getCreditNotePdf.php`, true);
                xmlhttp.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
                xmlhttp.send("id=" + credit_noteId);
            }
    ...
    <script>
        submitButton.addEventListener("click", e => {
            let currentCreditNoteId = submitButton.attributes["data-id"].value;
            ...
            if (editMessage.value != "") {
                ...
                xmlhttp.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
                xmlhttp.send(`id=${currentCreditNoteId}&message=${editMessage.value}`);
            } else {
