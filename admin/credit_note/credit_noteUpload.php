...
<body>
    ...
    <form action="#">
        <div class="inp-row adj-row row-5">
            ...
            <div class="inp-group">
                ...
                <input type="text" value="<?php echo  $creditnoteCopy ? $creditnoteDetails["credit_note_other_ref"] : ""; ?>" class="inp required" id="txtcreditnoteotherreference" placeholder="Credit Note PO No." data-id="txtcreditnoteotherreference" />
        ...
        <div class="inp-row adj-row row-5">
            <div class="inp-group">
                ...
                <input type="text" value="" class="inp required <?php echo $user_type != "super_admin" ? "disabled" : ""; ?>" tabindex="-1" id="txtcreditnoteno" placeholder="Credit Note No." data-id="txtcreditnoteno" />
                <div class="error-text" data-id="txtcreditnoteno">Cannot leave this field blank</div>
            </div>
            <!-- inp group end -->
            <div class="inp-group">
                <div class="inp-label">GST Percentage</div>
                <input type="text" value="<?php echo  $creditnoteCopy ? (strtolower($creditnoteDetails["credit_note_place_of_supply"]) == "maharashtra" ? $creditnoteDetails["credit_note_sgst_percentage"] * 2 : $creditnoteDetails["credit_note_igst_percentage"]) : ""; ?>" class="inp required" id="txtgst" placeholder="GST Percentage" data-id="txtgst" />
        ...
        <div class="inp-row adj-row row-5" style="justify-content: flex-start;">
            <div class="inp-group">
                ...
                <input type="text" value="<?php echo  $creditnoteCopy ? $creditnoteDetails["credit_note_place_of_supply"] : "Maharashtra"; ?>" class="inp required" id="txtplaceofsupply" placeholder="Credit Note No." data-id="txtplaceofsupply" />
            ...
            <div class="inp-group" style="margin-left: 28px;">
                ...
                <input type="text" value="<?php echo  $creditnoteCopy ? $creditnoteDetails["credit_note_ref"] : ""; ?>" class="inp" id="txtcreditnotereference" placeholder="Credit Note Reference" data-id="txtcreditnotereference" />
                <div class="error-text" data-id="txtcreditnotereference">Cannot leave this field blank</div>
            </div>
            <!-- inp group end -->
            <!-- <div class="inp-group" style="margin-left: 28px;">
                <div class="inp-label">PAN No.</div>
                <input type="text" value="<?php //echo  $creditnoteCopy ? $creditnoteDetails["credit_note_pan"] : ""; 
        ...
        submitBtn.addEventListener("click", e => {
            if (creditnotetable.creditnoteRows.length != 0) {
                ...
                if (isValid()) {
                    ...
                    xmlhttp.open("POST", `services/uploadCreditNote.php`, true);
    ...
    <script>
        let selectedFirm = "<?php echo $creditnoteCopy ? $creditnoteDetails["firm_id"] : ""; ?>";
        let selectedBank = "<?php echo $creditnoteCopy ? $creditnoteDetails["firm_bank_id"] : ""; ?>";
        let selectedSupplier = "<?php echo $creditnoteCopy ? $creditnoteDetails["supplier_id"] : ""; ?>";
        ...
        if (selectedFirm !== "") {
            ...
            getCreditNoteNo(selectedFirm, creditnoteDate.value);
        }
