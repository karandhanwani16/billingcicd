...
$query = "select max(debit_note_no) as current_max_debit_note_no from debit_note where firm_id = " . $firm . " and debit_note_date BETWEEN '" . $dateRange["start_date"] . "' and '" . $dateRange["end_date"] . "'";
...
if ($number_filter_row > 0) {
    ...
    $data = $row["current_max_debit_note_no"] == null ? 1 : $row["current_max_debit_note_no"] + 1;
}
