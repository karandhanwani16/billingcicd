...
<body>
    ...
    <form action="#">
        <div class="inp-row adj-row row-5">
            ...
            <div class="inp-group">
                ...
                <input type="text" value="<?php echo  $debitnoteEdit ? $debitnoteDetails["debit_note_other_ref"] : ""; ?>" class="inp required" id="txtdebitnoteotherreference" placeholder="Debit Note PO No." data-id="txtdebitnoteotherreference" />
        ...
        <div class="inp-row adj-row row-5">
            <div class="inp-group">
                ...
                <input type="text" value="<?php echo  $debitnoteEdit ? $debitnoteDetails["debit_note_no"] : ""; ?>" class="inp required <?php echo $user_type != "super_admin" ? "disabled" : ""; ?>" tabindex="-1" id="txtdebitnoteno" placeholder="Debit Note No." data-id="txtdebitnoteno" />
                <div class="error-text" data-id="txtdebitnoteno">Cannot leave this field blank</div>
            </div>
            <!-- inp group end -->
            <div class="inp-group">
                <div class="inp-label">GST Percentage</div>
                <input type="text" value="<?php echo  $debitnoteEdit ? (strtolower($debitnoteDetails["debit_note_place_of_supply"]) == "maharashtra" ? $debitnoteDetails["debit_note_sgst_percentage"] * 2 : $debitnoteDetails["debit_note_igst_percentage"]) : ""; ?>" class="inp required" id="txtgst" placeholder="GST Percentage" data-id="txtgst" />
        ...
        <div class="inp-row adj-row row-5" style="justify-content: flex-start;">
            <div class="inp-group">
                ...
                <input type="text" value="<?php echo  $debitnoteEdit ? $debitnoteDetails["debit_note_place_of_supply"] : "Maharastra"; ?>" class="inp required" id="txtplaceofsupply" placeholder="Debit Note No." data-id="txtplaceofsupply" />
            ...
            <div class="inp-group" style="margin-left: 28px;">
                ...
                <input type="text" value="<?php echo  $debitnoteEdit ? $debitnoteDetails["debit_note_ref"] : ""; ?>" class="inp" id="txtdebitnotereference" placeholder="Debit Note Reference" data-id="txtdebitnotereference" />
                <div class="error-text" data-id="txtdebitnotereference">Cannot leave this field blank</div>
            </div>
            <!-- inp group end -->
            <!-- <div class="inp-group" style="margin-left: 28px;">
                <div class="inp-label">PAN No.</div>
                <input type="text" value="<?php //echo  $debitnoteEdit ? $debitnoteDetails["debit_note_pan"] : ""; 
    ...
    <script>
        let debitnoteObject = {
            "id": "<?php echo $debitnoteEdit ? $curentId : ""; ?>",
        ...
        submitBtn.addEventListener("click", e => {
            if (debitnotetable.debitnoteRows.length != 0) {
                ...
                if (isValid()) {
                    ...
                    xmlhttp.open("POST", `services/updateDebitNote.php`, true);
    ...
    <script>
        let selectedFirm = "<?php echo $debitnoteEdit ? $debitnoteDetails["firm_id"] : ""; ?>";
        let selectedBank = "<?php echo $debitnoteEdit ? $debitnoteDetails["firm_bank_id"] : ""; ?>";
        let selectedSupplier = "<?php echo $debitnoteEdit ? $debitnoteDetails["supplier_id"] : ""; ?>";
