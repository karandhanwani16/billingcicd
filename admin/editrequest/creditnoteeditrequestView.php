...
<body>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">Credit Note Edit Request</div>
    ...
    <script>
        ...
        function editRequestAction(element, request_id, status) {
            ...
            xmlhttp.open("POST", `services/creditNoteEditRequestAction.php`, true);
            ...
            function downloadPdf(btn, id) {
                ...
                xmlhttp.onreadystatechange = function() {
                    if (this.readyState == 4 && this.status == 200) {
                        ...
                        link.href = "../credit_note/temp/Credit_note_" + result.id + "_" + result.user + ".pdf";
                        link.download = "Credit_note_" + result.id + "_" + result.user + ".pdf";
                        link.dispatchEvent(new MouseEvent('click'));
                    }
                };
                addLoadingStateWithText(btn, "Downloading...");
                xmlhttp.open("POST", `../credit_note/services/getCreditNotePdf.php`, true);
                xmlhttp.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
                xmlhttp.send("id=" + creditNoteId);
            }
