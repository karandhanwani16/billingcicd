...
<body>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">Debit Note Edit Request</div>
    ...
    <script>
        ...
        function editRequestAction(element, request_id, status) {
            ...
            xmlhttp.open("POST", `services/debitNoteEditRequestAction.php`, true);
            ...
            function downloadPdf(btn, id) {
                ...
                xmlhttp.onreadystatechange = function() {
                    if (this.readyState == 4 && this.status == 200) {
                        ...
                        link.href = "../debit_note/temp/Debit_note_" + result.id + "_" + result.user + ".pdf";
                        link.download = "Debit_note_" + result.id + "_" + result.user + ".pdf";
                        link.dispatchEvent(new MouseEvent('click'));
                    }
                };
                addLoadingStateWithText(btn, "Downloading...");
                xmlhttp.open("POST", `../debit_note/services/getDebitNotePdf.php`, true);
                xmlhttp.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
                xmlhttp.send("id=" + debitNoteId);
            }
