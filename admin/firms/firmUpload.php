    ...
    <form action="#">
        <div class="inp-row">
            <div class="inp-group">
                ...
                <input type="text" value="" class="inp required" id="txtfirmname" placeholder="Firm Name" data-id="txtfirmname" />
                <div class="error-text" data-id="txtfirmname">Cannot leave this field blank</div>
            </div>
            <!-- inp group end -->
            <div class="inp-group">
                <div class="inp-label">Firm GST Number</div>
                <input type="text" value="" class="inp required" id="txtfirmgstno" placeholder="Firm GST Number" data-id="txtfirmgstno" />
        ...
        <div class="inp-row">
            <div class="inp-group">
                ...
                <input type="text" value="" class="inp required" id="txtfirmaddress" placeholder="Firm Address" data-id="txtfirmaddress" />
                <div class="error-text" data-id="txtfirmaddress">Cannot leave this field blank</div>
            </div>
            <!-- inp group end -->
            <div class="inp-group">
                <div class="inp-label">Firm State</div>
                <input type="text" value="" class="inp required" id="txtfirmstate" placeholder="Firm State" data-id="txtfirmstate" />
        ...
        <div class="inp-row">
            <div class="inp-group">
                ...
                <input type="text" value="" class="inp required" id="txtfirmstatecode" placeholder="Firm State Code" data-id="txtfirmstatecode" />
        ...
        submitBtn.addEventListener("click", e => {
            ...
            if (banktable.bankRows.length > 0) {
                ...
                if (isValid()) {
                    ...
                    xmlhttp.open("POST", `services/uploadFirm.php`, true);
                    xmlhttp.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
                    xmlhttp.send("data=" + JSON.stringify(firmObject));
                }
            } else {
