...
<body style="padding: 16px 24px;">
    ...
    <script>
        ...
        function loadViewData() {
            ...
            xmlhttp.open("POST", `services/getCreditNoteMainReport.php`, true);
    ...
    <script>
        ...
        submitBtn.addEventListener("click", e => {
            ...
            xmlhttp.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    var result = JSON.parse(this.responseText);
                    filename = getMonthWord(fromMonthDdl.value) + "_" + fromYearDdl.value + "_" + getMonthWord(toMonthDdl.value) + "_" + toYearDdl.value + "_" + result.id + "_credit_note_report";
