...
$query = "select max(invoice_no) as current_max_invoice_no from invoice where firm_id = " . $firm . " and invoice_date BETWEEN '" . $dateRange["start_date"] . "' and '" . $dateRange["end_date"] . "'";
...
if ($number_filter_row > 0) {
    ...
    $data = $row["current_max_invoice_no"] == null ? 1 : $row["current_max_invoice_no"] + 1;
}
