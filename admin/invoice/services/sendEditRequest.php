...
try {
    $maxRequestId = getCurrentId("invoice_edit_request_id", "invoice_edit_request", $con);

    $sql = "insert into invoice_edit_request values(" . $maxRequestId . "," . $id . "," . $user_id . ",'" . getCurrentTimestamp() . "','false','false','" . $message . "')";
